...
$set_size_array = array(4,4,5,5,6,6);
...
$_SESSION['max_presentations'] = 30; 		# max trials to have in real study, 30, edited to be shorter
...
header("Location: http://cognitivetask.com/shortaospan/task/gen.php");
?>
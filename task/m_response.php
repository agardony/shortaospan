  ...
  <div id="canvas_area">
    ...
    <div id="fix_buttons">
	    <div id="row">
	      <div id="col2">
	      <center>
	        <form action="http://localhost:8000/task/get_feedback.php" method="post" onSubmit="document.getElementsByClassName('TF')[0].disabled=true;document.getElementsByClassName('TF')[1].disabled=true;">
...
<script>
    window.setTimeout(function(){
        ...
        window.location.href = "http://localhost:8000/task/get_feedback.php";
    }, 5000);
</script>
</html>
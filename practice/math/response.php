  ...
  <div id="canvas_area">
    ...
    <div id="fix_buttons">
	    <div id="row">
	      <div id="col2">
	      <center>
	        <form action="save_trial.php" method="post" onSubmit="document.getElementsByClassName('TF')[0].disabled=true;document.getElementsByClassName('TF')[1].disabled=true;">
...
<script>
    window.setTimeout(function(){
        ...
        window.location.href = "http://cognitivetask.com/shortaospan/practice/math/save_trial.php";
    }, 5000);
</script>
</html>
...
<div class="container">
  <div id="canvas_area">
    ...
    <div id="row">
      <div id="advance_area">
        <form action="http://localhost:8000/practice/mix/save_RT.php" method="post" onSubmit="document.getElementById('function_button').disabled=true;document.getElementById('function_button').value='Please Wait...';">
...
function trial(math_problem,user_timeout) {
  ...
  setTimeout(function() {
    window.location.replace('http://localhost:8000/practice/mix/save_RT.php');
  },user_timeout);
}
/* =======================================*/
